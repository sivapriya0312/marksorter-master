...
const styles = StyleSheet.create({
  ...
  amountSection: { margin: 0, paddingRight: 25, paddingTop: 5, justifyContent: 'flex-end', width: '196', },
  amountRow: { margin: 0, width: '100%', justifyContent: 'normal',  },
  pb5: { paddingBottom: 5 },
      ...
      <View style={[styles.bnk_det]}>
        ...
        <View style={[styles.bnk_det_tab2, styles.border]}>
          ...
          <View style={[styles.row, styles.amountSection]}>
              ...
              <Text style={styles.caption}>Gross Amount : </Text>
              <Text style={styles.tableCell}> 930000.00</Text>
                </View>
            </View>
            <View style={[styles.row, styles.amountSection]}>
                <View style={[styles.row, styles.amountRow]}>
              <Text style={styles.caption}>CGST ( 9.00 %) :</Text>
              <Text style={[styles.caption]}> 83700.00</Text>
                </View>
            </View>
            <View style={[styles.row, styles.amountSection]}>
                <View style={[styles.row, styles.amountRow]}>
              <Text style={styles.caption}>SGST ( 9.00 %) :</Text>
              <Text style={[styles.caption]}> 83700.00</Text>
                </View>
            </View>
            <View style={[styles.row, styles.amountSection]}>
                <View style={[styles.row, styles.amountRow]}>
              <Text style={styles.caption}>IGST ( 0.00 %) :</Text>
              <Text style={[styles.caption]}> 0.00</Text>
                </View>
            </View>
             <View style={[styles.row, styles.amountSection]}>
                 <View style={[styles.row, styles.amountRow]}>
              <Text style={styles.caption}>Round Off :</Text>
              <Text style={[styles.caption]}> 0.00</Text>
                </View>
             </View>
